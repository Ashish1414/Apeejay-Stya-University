...
//http://10.184.0.28/apricot/student_detail.json
public class Apricot extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.end_term)
        {
            ...
            Toast.makeText(Apricot.this,"CourseShopping Activity",Toast.LENGTH_LONG).show();
        }
